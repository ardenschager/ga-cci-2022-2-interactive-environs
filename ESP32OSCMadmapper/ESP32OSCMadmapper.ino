...
char ssid[] = "lumpySpacePrincess";          // your network SSID (name)
char pass[] = "stgeorge";                    // your network password

WiFiUDP Udp;                                // A UDP instance to let us send and receive packets over UDP
const IPAddress outIp(10,0,0,11);        // remote IP of your computer
